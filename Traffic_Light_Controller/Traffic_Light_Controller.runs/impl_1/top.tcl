namespace eval ::optrace {
  variable script "C:/Digital_System_Design/Traffic_Light_Controller/Traffic_Light_Controller.runs/impl_1/top.tcl"
...
OPTRACE "create in-memory project" START { }
  ...
  set_property board_part_repo_paths {C:/Users/11e26/AppData/Roaming/Xilinx/Vivado/2024.2/xhub/board_store/xilinx_board_store} [current_project]
  set_property board_part digilentinc.com:arty-s7-50:part0:1.1 [current_project]
  set_property design_mode GateLvl [current_fileset]
  set_param project.singleFileAddWarning.threshold 0
OPTRACE "create in-memory project" END { }
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir C:/Digital_System_Design/Traffic_Light_Controller/Traffic_Light_Controller.cache/wt [current_project]
  set_property parent.project_path C:/Digital_System_Design/Traffic_Light_Controller/Traffic_Light_Controller.xpr [current_project]
  set_property ip_output_repo C:/Digital_System_Design/Traffic_Light_Controller/Traffic_Light_Controller.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet C:/Digital_System_Design/Traffic_Light_Controller/Traffic_Light_Controller.runs/synth_1/top.dcp
OPTRACE "read constraints: implementation" START { }
  read_xdc C:/Digital_System_Design/Traffic_Light_Controller/Traffic_Light_Controller.srcs/constrs_1/new/traffic_const.xdc
